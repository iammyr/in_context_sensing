...
<div class="logo">
<h1><a href="index.php">inContext<span>Sensing</span> <small>Augment your sensor
data</small></a></h1>
</div>
<div class="clr"></div>
<div class="htext">
<h2>Linked Sensor Data</h2>
<p>Augment Sensor Data with additional contextual information
...
<li><a href="ld4sensors.php">LD4Sensors</a></li>	
...
<p>Sensor Data from Pachube View ID: <input type="text" name="feed_id"
	value="<?php if(isset($_POST['submit'])) { echo $_POST['feed_id'];}else{echo "17475";} ?>" /><br />
