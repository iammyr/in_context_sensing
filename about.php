...
<br />
        <p>
        <span style="font-weight: bold">LD4Sensors</span> is a generator of Linked Data descriptions for sensor metadata and sensor observations. It accepts input sent either manually by filling an online form or
        through a REST API (see <a href = "apiDocumentation.php">REST API DOCUMENTATION</a>).<br />
